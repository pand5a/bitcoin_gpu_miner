...
//        TransformD64Type TransformD64 = sha256::TransformD64;
    ...
    bool SelfTest() {
        ...
        static const uint32_t init[8] = {
                0x6a09e667ul, 0xbb67ae85ul, 0x3c6ef372ul, 0xa54ff53aul, 0x510e527ful, 0x9b05688cul, 0x1f83d9abul,
                0x5be0cd19ul
        };
...
////// SHA-256
    ...
    SHA256_CPU::SHA256_CPU() : bytes(0) {
        sha256::Initialize(s);
    }

    SHA256_CPU &SHA256_CPU::Write(const unsigned char *data, size_t len) {
    ...
    void SHA256_CPU::Finalize(unsigned char hash[OUTPUT_SIZE]) {
