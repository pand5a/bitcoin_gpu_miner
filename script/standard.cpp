...
CScriptID::CScriptID(const CScript& in) : BaseHash(Hash::Hash160(in)) {}
CScriptID::CScriptID(const ScriptHash& in) : BaseHash(static_cast<uint160>(in)) {}

ScriptHash::ScriptHash(const CScript& in) : BaseHash(Hash::Hash160(in)) {}
...
{
    sha256::SHA256_CPU().Write(in.data(), in.size()).Finalize(begin());
}
